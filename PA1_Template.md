...
This document summarises the R codes and outputs generated from
analysing a sample dataset collected a personal activity monitoring
device.
...
1.1 Check of data file already exists in working directory. Download and
unzip if file does not exist.
...
![](PA1_Template_files/figure-markdown_strict/plot_totalsteps-1.png)

2.3 What is the mean and median of the total number of steps taken per
day?
...
The mean of total number of steps taken per day is The median of total
number of steps taken per day is

Part 3 - What the average activity pattern?
-------------------------------------------

3.1 Make a time series plot of the 5 minute interval and average number
...
![](PA1_Template_files/figure-markdown_strict/plot_timeseries-1.png)
...
The interval with the maximum number of steps taken is 835, with 206
steps taken.

Part 4 - Inputing missing values
--------------------------------

4.1 Calculate and report the total number of missing values in the
...
![](PA1_Template_files/figure-markdown_strict/plot_totalsteps2-1.png)
...
The revised mean and median total number of steps taken differs from the
mean and median calculated using the old dataset (see section 2.3)

By replacing the NA values with the mean of the interval, we have
effectively aligned the mean and median number of steps.
...
![](PA1_Template_files/figure-markdown_strict/plot_timeseries2-1.png)
